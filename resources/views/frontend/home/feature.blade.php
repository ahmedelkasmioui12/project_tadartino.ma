 ...
 <section class="feature-section sec-pad bg-color-1" id="property" >
            <div class="auto-container">
                <div class="sec-title centred">
                    ...
                    <p>Explore our handpicked selection of premium properties that stand out in the market.                    </p>
                </div>
     ...
     <div class="btn-box"><a href="{{ url('property/details/'.$item->id.'/'.$item->property_slug) }}" class="theme-btn btn-two">See Details</a></div>
        ...
        @endforeach 
                ...
                <div class="more-btn centred">
                    <a href="{{ route('all.properties') }}" class="theme-btn btn-one">View All Listings</a>
