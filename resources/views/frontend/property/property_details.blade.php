  ...
  <figure class="author-thumb"><img src="{{ url('upload/ariyan.jpg') }}" alt=""></figure>
     ...
     <li><a href="property-details.html">{{ $property->type->type_name }}</a></li>
                        ...
                        <ul class="other-option pull-right clearfix">
                            ...
                            <li><a href="#" onclick="printPage(); return false;"><i class="icon-38"></i></a></li>
...
<ul class="info clearfix">
    ...
    <li><span>State/county:</span> {{ optional($property->pstate)->state_name }}</li>
            ...
            @endforeach
                            ...
                            <div class="statistics-box content-widget">
                                ...
                                <figure class="image-box">
                                    @if (strpos($property->property_video, 'youtube') !== false)
                                    ...
                                    @elseif (strpos($property->property_video, 'instagram') !== false)
                                       <blockquote class="instagram-media" data-instgrm-permalink="{{ $property->property_video }}" data-instgrm-version="14" style="width: 700px; max-width: 100%;"></blockquote>
                                       <script async src="//www.instagram.com/embed.js"></script>
                                    @elseif (strpos($property->property_video, 'tiktok') !== false)
                                       <blockquote class="tiktok-embed" cite="{{ $property->property_video }}" data-video-id="{{ substr($property->property_video, strrpos($property->property_video, '/') + 1) }}" style="max-width: 605px;min-width: 325px;" data-embed-from="embed_page">
                                          <section> </section>
                                       </blockquote> 
