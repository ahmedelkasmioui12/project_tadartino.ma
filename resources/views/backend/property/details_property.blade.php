...
<tr>
    ...
    <td>
        <code>
            {{ $property->pstate && $property->pstate->state_name ? $property->pstate->state_name : 'N/A' }}
        </code>
    </td>
</tr>
<tr>
...
<div class="table-responsive">
 ...
 <select name="amenities_id[]" class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%">
                 ...
                 <option value="{{ $ameni->amenitis_name }}" {{ (in_array($ameni->amenitis_name,$property_ami)) ? 'selected' : '' }} >{{ $ameni->amenitis_name }}</option>               @endforeach
