...
<input type="checkbox" name="featured" value="1" class="form-check-input" id="checkInline1" checked >
 ...
 <script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#myForm').on('submit', function (event) {
            ...
            // Check the size of the main thumbnail image
            if ($('#mainThmb')[0].src) {
                var file = $('input[name="property_thambnail"]')[0].files[0];
                if (file && file.size > maxSize) {
                    alert('The main thumbnail image must not be greater than 2MB.');
                    isValid = false;
                }
            }

            // Check the size of the multiple images
            $('#multiImg')[0].files.forEach(file => {
                if (file.size > maxSize) {
                    alert('Each image must not be greater than 2MB.');
                    isValid = false;
                }
            });
        ...
        // Check file size on image change (for multiple images)
