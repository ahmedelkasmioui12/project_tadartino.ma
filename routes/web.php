...
Route::middleware('auth')->group(function () {
 ...
 Route::get('/user/change/password', [UserController::class, 'UserChangePassword'])->name('user.change.password'); 
  ...
  Route::get('/user/properties/create', [UserController::class, 'createuserproperties'])->name('user.properties.create');
  Route::post('/user/properties/store', [UserController::class, 'storeuserproperties'])->name('user.properties.store');
...
Route::controller(PropertyController::class)->group(function(){
    ...
    Route::post('/store/new/multiimage', 'StoreNewMultiimage')->name('store.new.multiimage');
     ...
     Route::get('/dashboard/create-message', 'showForm')->name('create.message.form');
     Route::post('/dashboard/send-message', 'sendMessage')->name('send.message');
     ...
     //   Route::delete('/property/multiimg/delete/{id}', [PropertyController::class, 'PropertyMultiImageDelete'])->name('property.multiimg.delete');
...
Route::get('/agent/details/{id}', [IndexController::class, 'AgentDetails'])->name('agent.details');
 ...
 Route::get('/rent/property', [IndexController::class, 'RentProperty'])->name('rent.property');
  // Get All Buy Property 
   ...
   Route::get('/properties', [IndexController::class, 'AllProperties'])->name('all.properties');
   Route::get('/blogs', [IndexController::class, 'AllPost'])->name('all.blog');
